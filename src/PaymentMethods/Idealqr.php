...
use CardGate\Shopware\Handlers\IdealqrPaymentHandler;

class Idealqr implements PaymentMethodInterface
{
	/**
	 * {@inheritDoc}
	 *
	...
	{
		return __DIR__  . '/../Resources/views/storefront/cardgate/logo/idealqr.svg';
	}
