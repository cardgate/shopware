...
### Added
+ Add support for generic gateway, see [Generic Gateway FAQ](https://docs.cardgate.com/faq/general/generic-gateways/)
...
+ PLGSHPS6-111: Add German translation for CardGate plugin title
...
### Added
+ PLGSHPS6-4: Add CardGate payment method.
